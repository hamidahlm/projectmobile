...
import 'package:projectmobile/model/data_drama.dart';
import 'package:projectmobile/model/datalengkapdrama.dart';
...
class DramaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<DataDrama> data =
        data_drama.map((e) => DataDrama.fromJson(e)).toList();
    return Scaffold(
