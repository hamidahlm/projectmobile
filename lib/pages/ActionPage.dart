...
import 'package:projectmobile/model/data_action.dart';
import 'package:projectmobile/model/datalengkapaction.dart';
import 'package:projectmobile/widgets/CustomNavBar.dart';

class ActionPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    List<DataAction> data =
        data_action.map((e) => DataAction.fromJson(e)).toList();
    return Scaffold(
